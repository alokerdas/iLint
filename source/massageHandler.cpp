...
const char* giveMassage(int num)
{
  ...
  if (firstTime)
  {
    ...
    massages[1251] = "Case Equivalence Operator < %c > Not Synthesizable on < %s >.";
    ...
    massages[1257] = "Signals should be declared one per line with a comment at the end %s.";
    massages[1258] = "Macromodule < %s > should not be used because it is not synthesizable.";
    massages[1259] = "Defparam should not be used because it is not synthesizable.";
    massages[1260] = "Specify should not be used because it is not synthesizable.";
    massages[1261] = "< %s > compiler directive should not be used.";
    massages[1262] = "< %s > conditional compiler directive should not be used.";
    massages[1263] = "Unknown synopsys directive < %s > should not be used here.";
    massages[1264] = "Dc_shell commands < %s > should not be used here.";
    massages[1265] = "Define Statements Should be Put into One File.";
    massages[1266] = "Statement/expression used in < %s > may cause mismatch between pre-synthesis and post-synthesis.";
    massages[1267] = "Case statement with both < %s > directive clause may cause mismatch between pre-synthesis and post-synthesis.";
    massages[1268] = "Nested synopsys < %s > directive couldn't be used.";
    ...
    massages[1276] = "\"always_latch\" is not used to model sequential blocks.";
    massages[1277] = "%s.";
    ...
    massages[1289] = "Signal %s Assigned to 'x'.";
    massages[1290] = "UDP %sName \"%s\" should be named in lower case.";
    massages[1292] = "Instance name \"%s\" %s.";
    massages[1293] = "Module \"%s\" (of instance \"%s\") is named in the predefined pattern \".*%s*.";
